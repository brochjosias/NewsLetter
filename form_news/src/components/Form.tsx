...
const Form = () => {
  ...
  const [agree, setAgree] = useState(false) // Usuario tem q optar se nao nao vai prosseguir

  const [errors, setErrors] = useState<User | null>(null) // state pros erros
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    if(Object.keys(validateErrors).length > 0) { // se tiver mais que 0 errors
